...
-   HW 03 is due Monday, October 28 at 5:00pm
    -   All questions: Add alt text with `fig-alt`
-   RQ 4 is due Wednesday, October 30 at 5:00pm
...
# for github packages (make sure to use #| output: false)
pacman::p_load_gh("clauswilke/colorblindr")
...
nature <- read_csv(here::here("slides/14", "data/Nature_Graduate_Survey_2022.csv"))
glimpse(nature)
```
...
## Tips for Likert Data Plots!

Visit: <https://jakec007.github.io/2021-06-23-R-likert/>

-   Hint: this will help you with hw-03...
