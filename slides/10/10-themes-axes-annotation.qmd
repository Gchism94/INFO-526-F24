...
-   RQ 03 is due Wednesday, October 09 at 5:00pm
...
pac <- pac %>%
  janitor::clean_names() %>%
  mutate(
    year = str_extract(year, "\\d{4}-\\d{4}"),  # Extract the year range like '1999-2000'
    year = str_extract(year, "\\d{4}$"),  # Extract the last year in the range
