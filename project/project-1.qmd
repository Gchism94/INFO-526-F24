...
-   Week 1 of project (weeks of Sept 02): Choose a dataset and write up your proposal in `proposal.qmd`.

-   Week 2 of project (week of Sept 09): Provide peer review to two other teams in the form of issues in their GitHub repos, address the issues left on your team's project repo by closing them with explicit commits. Feel free to get started on your presentation as well.

-   Week 3 of project (week of Sept 16): Review feedback from me on your proposal and close any remaining issues. Work on your presentation in `presentation.qmd` and write-up in `index.qmd`.

-   Weeks 4-6 of project (week of Sept 23, 30, Oct 07): Finalize your write-up, presentation, and your project website. Present in class on the Wednesday (October 16th).

## Due dates

-   Proposals for peer review: due on Wednesday, September 11 at 2:00pm.
-   Revised proposals for teaching team review: due Monday, September 16 at 5:00pm.
